...
{
    public class PaymentConditionsStoredProcedures : IStoredProcedures
    {
        public PaymentConditionsStoredProcedures()
        {
        ...
        private void UpdateData()
        {
            if (!Helper.StoredProcedureExists($"dbo.{TableName}_Update", DatabaseNames.FinancialAnalysisDB))
            {
                ...
                sbSP.AppendLine(
                    $"CREATE PROCEDURE [{TableName}_Update] @PaymentConditionId int, @Name nvarchar(150), @Percentage money, @TimeValue int, @PayType int " +
        ...
        private void DeleteData()
        {
            if (!Helper.StoredProcedureExists($"dbo.{TableName}_Delete", DatabaseNames.FinancialAnalysisDB))
            {
                ...
                sbSP.AppendLine(
                    $"CREATE PROCEDURE [{TableName}_Delete] @PaymentConditionId int AS BEGIN SET NOCOUNT ON; " +

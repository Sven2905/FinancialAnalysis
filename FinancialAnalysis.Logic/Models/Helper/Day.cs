...
namespace FinancialAnalysis.Logic.Models.Helper
{
    public static class Day
    {
        ...
        public static bool IsHoliday(DateTime date, EnumFederalState federalState)
        {
            ...
            // Heilige Drei Könige
            if (federalState == EnumFederalState.BW || federalState == EnumFederalState.BY || federalState == EnumFederalState.ST)
            ...
            // Reformationstag
            if (federalState == EnumFederalState.BB || federalState == EnumFederalState.MV || federalState == EnumFederalState.SN || federalState == EnumFederalState.ST || federalState == EnumFederalState.TH)
                if (date.Day == 6 && date.Month == 1)
                    return true;

            // Allerheiligen
            if (federalState == EnumFederalState.BW || federalState == EnumFederalState.BY || federalState == EnumFederalState.NW || federalState == EnumFederalState.RP || federalState == EnumFederalState.SL)
        ...
        private static DateTime GetEasterSunday(int year)
        {
            ...
            month = 2 + (int)(os + 30) / 31;
            day = os - 31 * ((int)month / 4);

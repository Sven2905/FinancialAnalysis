...
namespace FinancialAnalysis.Logic.ViewModels
{
    public class TimeBookingOverviewViewModel : ViewModelBase
    {
        ...
        {
            if (UserManager.Instance.IsUserRightGranted(Globals.ActiveUser.UserId, Models.Administration.Permission.TimeBookingForOthers))
                ShowTimeBookingForOthers = true;
        }

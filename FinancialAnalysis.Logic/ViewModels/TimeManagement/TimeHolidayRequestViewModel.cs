...
namespace FinancialAnalysis.Logic.ViewModels
{
    public class TimeHolidayRequestViewModel : ViewModelBase
    {
        public TimeHolidayRequestViewModel()
        {
            ...
            NewTimeHolidayEmployee.RefEmployeeId = Globals.ActiveUser.RefEmployeeId;
        ...
        public TimeHolidayEmployee NewTimeHolidayEmployee { get; set; } = new TimeHolidayEmployee();
